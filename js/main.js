require([
    ...
    function callAPI() {
        $.getJSON("https://opensky-network.org/api/states/all?lamin=45.8389&lomin=5.9962&lamax=47.8229&lomax=10.5226", {USERNAME: "andrew_winchell", PASSWORD: "ColtEverett2301!"}, function(jsonData){
            var geoJson = {
